...
def compute_gradient_descent_test(w,b):
	print("Testing: compute_gradient_descent_test")
	predict1 = 3.5 * w + b
	print("Case 1")
	assert np.allclose(predict1, 0.49258551 )
	print("Case 1 passed!")
	predict2 = 7.0 * w + b
	print("Case 2")
	assert np.allclose(predict2, 4.53853794 )
	print("Case 2 passed!")
	print("\033[92mAll tests passed!")
